...
const Modal = ({ detailId, close }) => {
    // uçuş detay verisi sadece modal bileşeni içerisinde kullanılacağı için store'da tutma ihtiyacı duymadık
    ...
    useEffect(() => {
        ...
        axios.get('https://flight-radar1.p.rapidapi.com/flights/detail', {
            params,
            headers,
        })
            .then((res) => {
